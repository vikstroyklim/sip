...
const features = [
  {
    ...
    description: "Собственное производство с жестким контролем качества на каждом этапе прессования.",
    stat: "100",
    suffix: "%",
  },
  {
    icon: <Zap className="w-8 h-8" />,
    title: "Прочность OSB-3",
    description: "Используем только влагостойкие плиты Калевала или Талион толщиной 12 мм.",
    stat: "12",
    suffix: "мм",
  },
  {
    ...
    title: "Плотность ППС",
    description: "Фасадный пенополистирол марки ППС-16Ф с добавками антипирена (самозатухающий).",
    stat: "16",
    suffix: "кг/м³",
  },
  {
    ...
    <section id="tech" className="relative py-32 bg-[#050A18] overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="text-center mb-20">
          ...
          >
            Мы объединили автоматизацию, жесткий контроль качества и премиальное сырье для создания идеальных СИП-панелей.
          </motion.p>
        </div>
